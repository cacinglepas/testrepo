            ...
            <?php foreach ($event as $value){?>
              <article class="entry entry-single">
                ...
                <h2 class="entry-title">
                  <a href="event.php"><<?=$value['judul']; ?></a>
                </h2>

                <div class="entry-meta">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i><a href="event-single.php">Faridh Maulana</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-block"></i><a href="event-single.php"><time datetime="2022-09-14">sept,14 2022</time></a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i><a href="event-single.php">5 comments</a></li>
                  </ul>
                </div>

                < class="entry content">
                  <p>isi penjelasan event</p>
                  ...
                  <h3>judul paragraph</h3>
                  <p>isi paragraph</p>
                  <img src="<?=base_url()?>assets/img/bg jumbotron2.jpg" class="img fluid" alt="">
                ...
                <div class="entry-footer">
                  ...
                  <ul class="tags">
                    <li><a href="tags">Creative</a></li>
                    <li><a href="tags">Tips</a></li>
                    <li><a href="tags">Marketing</a></li>
                  </ul>
                </div>
                <?php } ?>
              </article>
                    ...
                    <div class="blog-comments">
                      ...
                      <div class="reply-form">
                        ...
                        <form action="">
                          ...
                          <button class="reply-form" type="submit"><i>Post Comment</i></button>
