  ...
  <body id="home">
    ...
    <header id="header" class="fixed-top ">
      <div class="container d-flex align-items-center">
        <a class="logo logo-img" style="margin-right: 10px;" href="<?=base_url()?>"><img src="<?=base_url()?>/assets/img/logo.png" alt="logo"></a>
        <h1 class="logo me-auto"><a href="<?=base_url()?>">Gemilang Permata</a></h1>
    ...
    <footer id="footer">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="#">Anggota</a></li>
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#services">Pengadaan dan Jasa</a></li>
                <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#services">Event Organizer</a></li>
                <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#services">Ekspedisi</a></li>
                <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#services">Percetakan</a></li>
                <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#services">Kuliner</a></li>
              </ul>
            </div>
      ...
      <div class="container footer-bottom clearfix">
        <div class="copyright">
          &copy; Copyright <strong><span>Gemilang Permata</span></strong
          >. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a class="text-white" href="https://www.linkedin.com/company/cv-gemilang-permata/">CV.Gemilang Permata</a>
        </div>
      </div>
    </footer>
    <!--end footer-->
    ...
    <script src="<?=base_url()?>/assets/vendor/slick-slider/slick.js"></script>
